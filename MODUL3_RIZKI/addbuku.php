...
<body>
	...
	<div class="container">
		...
		<form action="func.php" method="post" enctype="form-data">
			...
			<div class="form-group">
				<label>Penulis :</label>
				<input type="text" class="form-control" placeholder="Masukan Nama Penulis" name="penulis_buku" id="penulis_buku" required="required">
			</div>
			<div class="form-group">
			...
			<input type="button" name="send" value="submit" class="btn btn-primary">
		</form>
	</div>
